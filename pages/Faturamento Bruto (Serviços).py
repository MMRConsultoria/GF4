...
with aba2:
    ...
    if uploaded_file and df_final is not None:
        ...
        st.info("⚠️ Faça o upload e processamento do arquivo primeiro na aba anterior.")
...
with aba3:
    ...
    if uploaded_file and df_final is not None:
        ...
        st.info("⚠️ Faça o upload e processamento primeiro.")
